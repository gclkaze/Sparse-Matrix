...
class ISparseMatrix /*: virtual public IMatrix*/ {
   public:
    ...
    virtual bool insert(const TupleNode* tuple, int sz) = 0;
    ...
    virtual void putChildren(FlatChildEntry* children, int amount) = 0;
    virtual void putNodes(FlatNode* nodes, int amount) = 0;
